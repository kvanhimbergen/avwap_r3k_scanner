...
def main() -> int:
    ...
    tests = [
        ...
        root / "tests" / "test_atomic_write.py"
        root / "tests" / "test_avwap_check.py"
        ...
        root / "tests" / "test_execution_main_config_check.py"
        root / "tests" / "test_execution_main_dry_run_ledger.py"
        root / "tests" / "test_execution_v2_buy_loop_attribution_fail_open.py"
        ...
        root / "tests" / "test_exits_import_guard.py"
        ...
        root / "tests" / "test_risk_attribution_rolling.py"
